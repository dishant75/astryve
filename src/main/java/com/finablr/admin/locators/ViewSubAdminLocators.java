...
public class ViewSubAdminLocators {
	...
	public static final String Get_EmailAddress="//table/tbody/tr/td[3]";
	public static final String Get_Fullname="//table/tbody/tr/td[1]/a";
	public static final String Get_Role="//table/tbody/tr/td[2]";
