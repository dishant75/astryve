...
public class ReadExcelFile {
	...
	public int retrieveNoOfCols() {
		...
		/*
		 * Rest of Below Code is Written to Exclude any Blank Columns after Test Data
		 * Ends in Count. It works best for only that Case. If any Blank Column in
		 * Between the Test Data, it should be rectified manually.
		 */
		int actualColumns = 0;
		HSSFRow row = ws.getRow(0);
